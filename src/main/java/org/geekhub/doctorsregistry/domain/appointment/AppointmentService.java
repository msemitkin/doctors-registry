...
public class AppointmentService {
    ...
    public void create(AppointmentEntity appointmentEntity) {
        ...
        if (patientHasAppointmentOnSelectedTime(appointmentEntity)) {
    ...
    private boolean patientHasAppointmentOnSelectedTime(AppointmentEntity appointmentEntity) {
    ...
    private boolean isDateTimeNotAllowed(LocalDateTime dateTime) {
        return !(AppointmentTime.isTimeValid(dateTime.toLocalTime())
                 && zonedTime.now().toLocalDate().isBefore(dateTime.toLocalDate()));
    }
