...
public class AppointmentServiceTest {
    ...
    @Mock
    private PatientJdbcTemplateRepository patientRepository;
    @Mock
    ...
    public void setUp() {
        ...
        appointmentService = new AppointmentService(appointmentRepository, patientRepository, appointmentValidator);
    }
